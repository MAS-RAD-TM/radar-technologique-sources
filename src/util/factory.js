...
const App = function () {
    ...
    self.build = function () {
        ...
        if (queryParams.f) {
            ...
            var versionsList = '<div class="numberlist"><ul>';
            ...
            getSheetList(
                function (allFiles) {
                    ...
                    plotBanner(content, bannerText,versionsList);
...
function plotBanner(content, text,versionsList) {


    content
        .append('div')
        .attr('class', 'input-sheet__banner')
        .html(text.concat(versionsList));
