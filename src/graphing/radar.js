...
const Radar = function (size, radar) {
  ...
  function drawBlipInCoordinates(blip, coordinates, order, quadrantGroup, ringList) {
    ...
    var blipTopicText =  (blip.topic() ? (' - ' +  blip.topic()) : '')
  ...
  function drawLegend(order) {
    ...
    var triangleKey = "Nouveau ou déplacé";
    var circleKey = "Pas de changement";
  ...
  function plotRadarHeader() {
    ...
    header.select('.radar-title')
      ...
      .html('<a href="http://globaz.ch"> <img src="/images/logo-crafts.png" /> </a>');
